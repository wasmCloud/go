...
func Get(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, key string) (r0__ *wrpc.Result[[]uint8, Error], err__ error) {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `bucket` parameter: %w", err__)
		return
	}
	...
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `bucket` parameter")
		return
	}
	if write1__ != nil {
	...
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "get", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "get", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "get", "err", cErr__)
	}
...
//
// If any other error occurs, it returns an `Err(error)`.
func Set(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, key string, value []uint8) (r0__ *wrpc.Result[struct{}, Error], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "set", buf__.Bytes())
	if err__ != nil {
		err__ = fmt.Errorf("failed to invoke `set`: %w", err__)
		return
	}
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "set", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "set", "err", cErr__)
	}
...
//
// If any other error occurs, it returns an `Err(error)`.
func Delete(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, key string) (r0__ *wrpc.Result[struct{}, Error], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "delete", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "delete", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "delete", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, Error], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
//
// If any other error occurs, it returns an `Err(error)`.
func Exists(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, key string) (r0__ *wrpc.Result[bool, Error], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "exists", buf__.Bytes())
	if err__ != nil {
		err__ = fmt.Errorf("failed to invoke `exists`: %w", err__)
		return
	}
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "exists", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "exists", "err", cErr__)
	}
...
func ListKeys(ctx__ context.Context, wrpc__ wrpc.Invoker, bucket string, cursor *uint64) (r0__ *wrpc.Result[KeyResponse, Error], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wrpc:keyvalue/store@0.2.0-draft", "list-keys", buf__.Bytes())
	if err__ != nil {
		err__ = fmt.Errorf("failed to invoke `list-keys`: %w", err__)
		return
	}
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "list-keys", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wrpc:keyvalue/store@0.2.0-draft", "name", "list-keys", "err", cErr__)
	}
