...
import (
	...
	errors "errors"
	fmt "fmt"
	wasi__clocks__monotonic_clock "github.com/wasmCloud/go/examples/provider/http-server/bindings/wasi/clocks/monotonic_clock"
	wasi__io__error "github.com/wasmCloud/go/examples/provider/http-server/bindings/wasi/io/error"
	wasi__io__poll "github.com/wasmCloud/go/examples/provider/http-server/bindings/wasi/io/poll"
	wasi__io__streams "github.com/wasmCloud/go/examples/provider/http-server/bindings/wasi/io/streams"
	io "io"
	slog "log/slog"
	math "math"
	sync "sync"
...
// http-related errors.
func HttpErrorCode(ctx__ context.Context, wrpc__ wrpc.Invoker, err wrpc.Borrow[IoError]) (r0__ *ErrorCode, err__ error) {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `err` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `err` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "http-error-code", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "http-error-code", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "http-error-code", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*ErrorCode, error) {
		...
		case 1:
			...
			v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*ErrorCode, error) {
				v := &ErrorCode{}
				...
				case ErrorCodeDnsError:
					payload, err := func(r wrpc.IndexReadCloser, path ...uint32) (*DnsErrorPayload, error) {
						v := &DnsErrorPayload{}
						var err error
						slog.Debug("reading field", "name", "rcode")
						v.Rcode, err = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
							slog.Debug("reading option status byte")
							status, err := r.ReadByte()
							if err != nil {
								return nil, fmt.Errorf("failed to read option status byte: %w", err)
						...
						v.InfoCode, err = func(r wrpc.IndexReadCloser, path ...uint32) (*uint16, error) {
							slog.Debug("reading option status byte")
							status, err := r.ReadByte()
							if err != nil {
								return nil, fmt.Errorf("failed to read option status byte: %w", err)
				...
				case ErrorCodeTlsAlertReceived:
					payload, err := func(r wrpc.IndexReadCloser, path ...uint32) (*TlsAlertReceivedPayload, error) {
						v := &TlsAlertReceivedPayload{}
						var err error
						slog.Debug("reading field", "name", "alert-id")
						v.AlertId, err = func(r wrpc.IndexReadCloser, path ...uint32) (*uint8, error) {
							slog.Debug("reading option status byte")
							status, err := r.ReadByte()
							if err != nil {
								return nil, fmt.Errorf("failed to read option status byte: %w", err)
						...
						v.AlertMessage, err = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
							slog.Debug("reading option status byte")
							status, err := r.ReadByte()
							if err != nil {
								return nil, fmt.Errorf("failed to read option status byte: %w", err)
				...
				case ErrorCodeHttpRequestBodySize:
					payload, err := func(r wrpc.IndexReadCloser, path ...uint32) (*uint64, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
				...
				case ErrorCodeHttpRequestHeaderSectionSize:
					payload, err := func(r wrpc.IndexReadCloser, path ...uint32) (*uint32, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
				...
				case ErrorCodeHttpRequestHeaderSize:
					payload, err := func(r wrpc.IndexReadCloser, path ...uint32) (*FieldSizePayload, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
						...
						case 1:
							slog.Debug("reading `option::some` payload")
							v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*FieldSizePayload, error) {
								v := &FieldSizePayload{}
								var err error
								slog.Debug("reading field", "name", "field-name")
								v.FieldName, err = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
									slog.Debug("reading option status byte")
									status, err := r.ReadByte()
									if err != nil {
										return nil, fmt.Errorf("failed to read option status byte: %w", err)
								...
								v.FieldSize, err = func(r wrpc.IndexReadCloser, path ...uint32) (*uint32, error) {
									slog.Debug("reading option status byte")
									status, err := r.ReadByte()
									if err != nil {
										return nil, fmt.Errorf("failed to read option status byte: %w", err)
				...
				case ErrorCodeHttpResponseTransferCoding:
					payload, err := func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
...
func NewFields(ctx__ context.Context, wrpc__ wrpc.Invoker) (r0__ wrpc.Own[Fields], err__ error) {
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields", nil)
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[constructor]fields", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[constructor]fields", "err", cErr__)
	}
...
func Fields_FromList(ctx__ context.Context, wrpc__ wrpc.Invoker, entries []*wrpc.Tuple2[string, []uint8]) (r0__ *wrpc.Result[wrpc.Own[Fields], HeaderError], err__ error) {
	var buf__ bytes.Buffer
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `entries` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `entries` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields.from-list", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[static]fields.from-list", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[static]fields.from-list", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Own[Fields], HeaderError], error) {
		...
		case 1:
			...
			v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*HeaderError, error) {
				v := &HeaderError{}
				n, err := func(r io.ByteReader) (uint8, error) {
					var x uint8
					var s uint
...
func Fields_Get(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Fields], name string) (r0__ [][]uint8, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields.get", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.get", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.get", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) ([][]uint8, error) {
		var x uint32
		var s uint
		for i := 0; i < 5; i++ {
...
func Fields_Has(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Fields], name string) (r0__ bool, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields.has", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.has", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.has", "err", cErr__)
	}
...
func Fields_Set(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Fields], name string, value [][]uint8) (r0__ *wrpc.Result[struct{}, HeaderError], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields.set", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.set", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.set", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, HeaderError], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
...
//
// Fails with `header-error.immutable` if the `fields` are immutable.
func Fields_Delete(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Fields], name string) (r0__ *wrpc.Result[struct{}, HeaderError], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields.delete", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.delete", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.delete", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, HeaderError], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
//
// Fails with `header-error.immutable` if the `fields` are immutable.
func Fields_Append(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Fields], name string, value []uint8) (r0__ *wrpc.Result[struct{}, HeaderError], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields.append", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.append", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.append", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, HeaderError], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
// which have multiple values are represented by multiple entries in this
// list with the same key.
func Fields_Entries(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Fields]) (r0__ []*wrpc.Tuple2[string, []uint8], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields.entries", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.entries", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.entries", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) ([]*wrpc.Tuple2[string, []uint8], error) {
		var x uint32
		var s uint
		for i := 0; i < 5; i++ {
			slog.Debug("reading list length byte", "i", i)
			...
			if b < 0x80 {
				...
				for i := range vs {
					slog.Debug("reading list element", "i", i)
					vs[i], err = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Tuple2[string, []uint8], error) {
...
// `fields` is mutable.
func Fields_Clone(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[Fields]) (r0__ wrpc.Own[Fields], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "fields.clone", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.clone", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]fields.clone", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func IncomingRequest_Method(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingRequest]) (r0__ *Method, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-request.method", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.method", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.method", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*Method, error) {
		v := &Method{}
		n, err := func(r io.ByteReader) (uint8, error) {
			var x uint8
			var s uint
...
func IncomingRequest_PathWithQuery(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingRequest]) (r0__ *string, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-request.path-with-query", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.path-with-query", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.path-with-query", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read option status byte: %w", err)
...
func IncomingRequest_Scheme(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingRequest]) (r0__ *Scheme, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-request.scheme", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.scheme", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.scheme", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*Scheme, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read option status byte: %w", err)
		...
		case 1:
			slog.Debug("reading `option::some` payload")
			v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*Scheme, error) {
				v := &Scheme{}
				n, err := func(r io.ByteReader) (uint8, error) {
					var x uint8
					var s uint
...
func IncomingRequest_Authority(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingRequest]) (r0__ *string, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-request.authority", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.authority", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.authority", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
...
func IncomingRequest_Headers(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingRequest]) (r0__ wrpc.Own[Headers], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-request.headers", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.headers", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.headers", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func IncomingRequest_Consume(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingRequest]) (r0__ *wrpc.Result[wrpc.Own[IncomingBody], struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-request.consume", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.consume", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-request.consume", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Own[IncomingBody], struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
...
func NewOutgoingRequest(ctx__ context.Context, wrpc__ wrpc.Invoker, headers wrpc.Own[Headers]) (r0__ wrpc.Own[OutgoingRequest], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `headers` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `headers` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[constructor]outgoing-request", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[constructor]outgoing-request", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func OutgoingRequest_Body(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest]) (r0__ *wrpc.Result[wrpc.Own[OutgoingBody], struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.body", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.body", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.body", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Own[OutgoingBody], struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
...
func OutgoingRequest_Method(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest]) (r0__ *Method, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.method", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.method", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.method", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*Method, error) {
		v := &Method{}
		n, err := func(r io.ByteReader) (uint8, error) {
...
func OutgoingRequest_SetMethod(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest], method *Method) (r0__ *wrpc.Result[struct{}, struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `method` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `self` parameter")
	...
	if write1__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `method` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.set-method", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.set-method", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.set-method", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
...
func OutgoingRequest_PathWithQuery(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest]) (r0__ *string, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.path-with-query", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.path-with-query", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.path-with-query", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
...
func OutgoingRequest_SetPathWithQuery(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest], pathWithQuery *string) (r0__ *wrpc.Result[struct{}, struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `path-with-query` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `self` parameter")
	...
	if write1__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `path-with-query` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.set-path-with-query", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.set-path-with-query", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.set-path-with-query", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
func OutgoingRequest_Scheme(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest]) (r0__ *Scheme, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.scheme", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.scheme", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.scheme", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*Scheme, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
...
func OutgoingRequest_SetScheme(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest], scheme *Scheme) (r0__ *wrpc.Result[struct{}, struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `scheme` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `self` parameter")
	...
	if write1__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `scheme` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.set-scheme", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.set-scheme", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.set-scheme", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
func OutgoingRequest_Authority(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest]) (r0__ *string, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.authority", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.authority", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.authority", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*string, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
...
func OutgoingRequest_SetAuthority(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest], authority *string) (r0__ *wrpc.Result[struct{}, struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `authority` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `self` parameter")
	...
	if write1__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `authority` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.set-authority", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.set-authority", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.set-authority", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
func OutgoingRequest_Headers(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingRequest]) (r0__ wrpc.Own[Headers], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-request.headers", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.headers", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-request.headers", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func NewRequestOptions(ctx__ context.Context, wrpc__ wrpc.Invoker) (r0__ wrpc.Own[RequestOptions], err__ error) {
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "request-options", nil)
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[constructor]request-options", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[constructor]request-options", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func RequestOptions_ConnectTimeout(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[RequestOptions]) (r0__ *Duration, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "request-options.connect-timeout", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.connect-timeout", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.connect-timeout", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*Duration, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read option status byte: %w", err)
...
func RequestOptions_SetConnectTimeout(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[RequestOptions], duration *Duration) (r0__ *wrpc.Result[struct{}, struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `duration` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `self` parameter")
	...
	if write1__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `duration` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "request-options.set-connect-timeout", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.set-connect-timeout", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.set-connect-timeout", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
func RequestOptions_FirstByteTimeout(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[RequestOptions]) (r0__ *Duration, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "request-options.first-byte-timeout", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.first-byte-timeout", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.first-byte-timeout", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*Duration, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
...
func RequestOptions_SetFirstByteTimeout(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[RequestOptions], duration *Duration) (r0__ *wrpc.Result[struct{}, struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "request-options.set-first-byte-timeout", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.set-first-byte-timeout", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.set-first-byte-timeout", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
// body stream.
func RequestOptions_BetweenBytesTimeout(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[RequestOptions]) (r0__ *Duration, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "request-options.between-bytes-timeout", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.between-bytes-timeout", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.between-bytes-timeout", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*Duration, error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
...
// supported.
func RequestOptions_SetBetweenBytesTimeout(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[RequestOptions], duration *Duration) (r0__ *wrpc.Result[struct{}, struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "request-options.set-between-bytes-timeout", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.set-between-bytes-timeout", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]request-options.set-between-bytes-timeout", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
func ResponseOutparam_Set(ctx__ context.Context, wrpc__ wrpc.Invoker, param wrpc.Own[ResponseOutparam], response *wrpc.Result[wrpc.Own[OutgoingResponse], ErrorCode]) (err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `param` parameter: %w", err__)
		return
	}
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `response` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `param` parameter")
		return
	}
	if write1__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `response` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "response-outparam.set", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[static]response-outparam.set", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[static]response-outparam.set", "err", cErr__)
	}
	return
}

// Returns the status code from the incoming response.
func IncomingResponse_Status(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingResponse]) (r0__ uint16, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-response.status", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-response.status", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-response.status", "err", cErr__)
	}
	r0__, err__ = func(r io.ByteReader) (uint16, error) {
		var x uint16
		var s uint8
		for i := 0; i < 3; i++ {
			slog.Debug("reading u16 byte", "i", i)
...
func IncomingResponse_Headers(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingResponse]) (r0__ wrpc.Own[Headers], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-response.headers", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-response.headers", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-response.headers", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func IncomingResponse_Consume(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingResponse]) (r0__ *wrpc.Result[wrpc.Own[IncomingBody], struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-response.consume", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-response.consume", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-response.consume", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Own[IncomingBody], struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
func IncomingBody_Stream(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[IncomingBody]) (r0__ *wrpc.Result[wrpc.Own[InputStream], struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-body.stream", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-body.stream", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]incoming-body.stream", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Own[InputStream], struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
...
func IncomingBody_Finish(ctx__ context.Context, wrpc__ wrpc.Invoker, this wrpc.Own[IncomingBody]) (r0__ wrpc.Own[FutureTrailers], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `this` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `this` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "incoming-body.finish", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[static]incoming-body.finish", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[static]incoming-body.finish", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func FutureTrailers_Subscribe(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[FutureTrailers]) (r0__ wrpc.Own[Pollable], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "future-trailers.subscribe", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]future-trailers.subscribe", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]future-trailers.subscribe", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func FutureTrailers_Get(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[FutureTrailers]) (r0__ *wrpc.Result[wrpc.Result[*wrpc.Own[Trailers], ErrorCode], struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "future-trailers.get", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]future-trailers.get", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]future-trailers.get", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Result[*wrpc.Own[Trailers], ErrorCode], struct{}], error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read option status byte: %w", err)
		...
		case 1:
			slog.Debug("reading `option::some` payload")
			v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Result[*wrpc.Own[Trailers], ErrorCode], struct{}], error) {
				slog.Debug("reading result status byte")
				status, err := r.ReadByte()
				if err != nil {
					return nil, fmt.Errorf("failed to read result status byte: %w", err)
				...
				case 0:
					slog.Debug("reading `result::ok` payload")
					v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[*wrpc.Own[Trailers], ErrorCode], error) {
						slog.Debug("reading result status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read result status byte: %w", err)
						...
						case 0:
							slog.Debug("reading `result::ok` payload")
							v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Own[Trailers], error) {
								slog.Debug("reading option status byte")
								status, err := r.ReadByte()
								if err != nil {
									return nil, fmt.Errorf("failed to read option status byte: %w", err)
...
func NewOutgoingResponse(ctx__ context.Context, wrpc__ wrpc.Invoker, headers wrpc.Own[Headers]) (r0__ wrpc.Own[OutgoingResponse], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-response", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[constructor]outgoing-response", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[constructor]outgoing-response", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
func OutgoingResponse_StatusCode(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingResponse]) (r0__ uint16, err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-response.status-code", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-response.status-code", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-response.status-code", "err", cErr__)
	}
	r0__, err__ = func(r io.ByteReader) (uint16, error) {
		var x uint16
		var s uint8
...
func OutgoingResponse_SetStatusCode(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingResponse], statusCode uint16) (r0__ *wrpc.Result[struct{}, struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `status-code` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `self` parameter")
	...
	if write1__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `status-code` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-response.set-status-code", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-response.set-status-code", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-response.set-status-code", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
// `outgoing-request` is dropped, or its ownership is transfered to
// another component by e.g. `outgoing-handler.handle`.
func OutgoingResponse_Headers(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingResponse]) (r0__ wrpc.Own[Headers], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-response.headers", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-response.headers", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-response.headers", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
// calls will return error.
func OutgoingResponse_Body(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingResponse]) (r0__ *wrpc.Result[wrpc.Own[OutgoingBody], struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-response.body", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-response.body", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-response.body", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Own[OutgoingBody], struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
...
// will return error.
func OutgoingBody_Write(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[OutgoingBody]) (r0__ *wrpc.Result[wrpc.Own[OutputStream], struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-body.write", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-body.write", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]outgoing-body.write", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Own[OutputStream], struct{}], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
...
// Content-Length.
func OutgoingBody_Finish(ctx__ context.Context, wrpc__ wrpc.Invoker, this wrpc.Own[OutgoingBody], trailers *wrpc.Own[Trailers]) (r0__ *wrpc.Result[struct{}, ErrorCode], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	if err__ != nil {
		err__ = fmt.Errorf("failed to write `trailers` parameter: %w", err__)
		return
	}
	if write0__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `this` parameter")
	...
	if write1__ != nil {
		err__ = errors.New("unexpected deferred write for synchronous `trailers` parameter")
		return
	}
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "outgoing-body.finish", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[static]outgoing-body.finish", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[static]outgoing-body.finish", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[struct{}, ErrorCode], error) {
		slog.Debug("reading result status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read result status byte: %w", err)
...
// been received, or an error has occured. When this pollable is ready,
// the `get` method will return `some`.
func FutureIncomingResponse_Subscribe(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[FutureIncomingResponse]) (r0__ wrpc.Own[Pollable], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "future-incoming-response.subscribe", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]future-incoming-response.subscribe", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]future-incoming-response.subscribe", "err", cErr__)
	}
	r0__, err__ = func(r interface {
		io.ByteReader
		io.Reader
...
// `output-stream` child.
func FutureIncomingResponse_Get(ctx__ context.Context, wrpc__ wrpc.Invoker, self wrpc.Borrow[FutureIncomingResponse]) (r0__ *wrpc.Result[wrpc.Result[wrpc.Own[IncomingResponse], ErrorCode], struct{}], err__ error) {
	var buf__ bytes.Buffer
	write0__, err__ := (func(wrpc.IndexWriter) error)(nil), func(v string, w io.Writer) (err error) {
		n := len(v)
		if n > math.MaxUint32 {
	...
	var w__ wrpc.IndexWriteCloser
	var r__ wrpc.IndexReadCloser
	w__, r__, err__ = wrpc__.Invoke(ctx__, "wasi:http/types@0.2.0", "future-incoming-response.get", buf__.Bytes())
	if err__ != nil {
	...
	defer func() {
		if err := r__.Close(); err != nil {
			slog.ErrorContext(ctx__, "failed to close reader", "instance", "wasi:http/types@0.2.0", "name", "[method]future-incoming-response.get", "err", err)
		}
	}()
	if cErr__ := w__.Close(); cErr__ != nil {
		slog.DebugContext(ctx__, "failed to close outgoing stream", "instance", "wasi:http/types@0.2.0", "name", "[method]future-incoming-response.get", "err", cErr__)
	}
	r0__, err__ = func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Result[wrpc.Own[IncomingResponse], ErrorCode], struct{}], error) {
		slog.Debug("reading option status byte")
		status, err := r.ReadByte()
		if err != nil {
			return nil, fmt.Errorf("failed to read option status byte: %w", err)
		...
		case 1:
			slog.Debug("reading `option::some` payload")
			v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Result[wrpc.Own[IncomingResponse], ErrorCode], struct{}], error) {
				slog.Debug("reading result status byte")
				status, err := r.ReadByte()
				if err != nil {
					return nil, fmt.Errorf("failed to read result status byte: %w", err)
				...
				case 0:
					slog.Debug("reading `result::ok` payload")
					v, err := func(r wrpc.IndexReadCloser, path ...uint32) (*wrpc.Result[wrpc.Own[IncomingResponse], ErrorCode], error) {
						slog.Debug("reading result status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read result status byte: %w", err)
