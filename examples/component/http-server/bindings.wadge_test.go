...
//go:linkname wasmimport_errorContextDebugMessage go.wasmcloud.dev/component/cm.wasmimport_errorContextDebugMessage
func wasmimport_errorContextDebugMessage(err go_wasmcloud_dev__component__cm.errorContext, msg unsafe.Pointer) {
...
//go:linkname wasmimport_errorContextDrop go.wasmcloud.dev/component/cm.wasmimport_errorContextDrop
func wasmimport_errorContextDrop(err go_wasmcloud_dev__component__cm.errorContext) {
	var __p runtime.Pinner
	defer __p.Unpin()
	if __err := wadge.WithCurrentInstance(func(__instance *wadge.Instance) error {
