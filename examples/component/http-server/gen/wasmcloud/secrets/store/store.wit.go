...
var _SecretsErrorStrings = [3]string{
	"upstream",
	"io",
	"not-found",
}
...
func (v SecretsError) String() string {
	return _SecretsErrorStrings[v.Tag()]
}
...
//		bytes(list<u8>),
//	}
type SecretValue cm.Variant[uint8, string, string]
...
var _SecretValueStrings = [2]string{
	"string",
	"bytes",
}
...
func (v SecretValue) String() string {
	return _SecretValueStrings[v.Tag()]
}
