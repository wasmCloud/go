...
//go:wasmexport wasmcloud:nats/jetstream-handler@0.1.0#handle-message
func wasm_export_wasmcloud_nats_0_1_0_jetstream_handler_handle_message(arg0 int32) uintptr {
...
//go:wasmexport cabi_post_wasmcloud:nats/jetstream-handler@0.1.0#handle-message
func wasm_export_post_return_wasmcloud_nats_0_1_0_jetstream_handler_handle_message(result uintptr) {
