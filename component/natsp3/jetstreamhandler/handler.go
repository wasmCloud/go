...
//
//	func init() {
//	  jetstreamhandler.HandleFunc(func(h *natsp3.MessageHandle) error {
...
import (
	...
	export "go.wasmcloud.dev/component/exports/wasmcloud_component_go_wasmcloud_nats_async_jetstream_handler_0_2_0/export_wasmcloud_nats_0_2_0_jetstream_handler"
	...
	_ "go.wasmcloud.dev/component/exports/wasmcloud_component_go_wasmcloud_nats_async_jetstream_handler_0_2_0/wit_exports"
)
...
func HandleFunc(fn func(handle *natsp3.MessageHandle) error) {
	export.Exports.HandleMessage = func(handle *js.MessageHandle) witTypes.Result[witTypes.Unit, string] {
		if err := fn(natsp3.NewMessageHandle(handle)); err != nil {
