...
//
//	func init() {
//	  kvhandler.HandleFunc(func(bucket string, e natsp3.Entry) error {
//	    if e.Operation == natsp3.OperationDelete {
//	      return evict(e.Key)
//	    }
...
import (
	...
	export "go.wasmcloud.dev/component/exports/wasmcloud_component_go_wasmcloud_nats_async_kv_handler_0_2_0/export_wasmcloud_nats_0_2_0_kv_handler"
	kv "go.wasmcloud.dev/component/imports/wasmcloud_nats_0_2_0_kv"
	"go.wasmcloud.dev/component/natsp3"

	// Pull in the //go:wasmexport glue for the handle-event export.
	_ "go.wasmcloud.dev/component/exports/wasmcloud_component_go_wasmcloud_nats_async_kv_handler_0_2_0/wit_exports"
)
...
func HandleFunc(fn func(bucket string, entry natsp3.Entry) error) {
	export.Exports.HandleEvent = func(bucket string, entry kv.Entry) witTypes.Result[witTypes.Unit, string] {
		if err := fn(bucket, natsp3.FromWitEntry(entry)); err != nil {
